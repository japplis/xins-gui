/*
 * $Id: FunctionOverviewPanel.java,v 1.1 2005/06/06 15:03:31 znerd Exp $
 *
...
/**
 * Panel that displays an overview of the current function.
 *
 * @version $Revision: 1.1 $ $Date: 2005/06/06 15:03:31 $
 * @author Ernst de Haan (<a href="mailto:ernst.dehaan@nl.wanadoo.com">ernst.dehaan@nl.wanadoo.com</a>)
 */
public final class FunctionOverviewPanel
extends JPanel {
   ...
   /**
    * Constructs a new <code>FunctionOverviewPanel</code> instance.
    */
   public FunctionOverviewPanel() {
      ...
      String tp = "panels.FunctionOverview.";

      // Construct components
      JLabel nameLabel = Utils.createJLabel(tp, "Name");
      JLabel descLabel = Utils.createJLabel(tp, "Description");
      _nameField       = Utils.createJTextField(nameLabel, null); // TODO: FunctionNodeType.NAME_PATTERN);
      JScrollPane desc = Utils.createJTextArea(descLabel, null);  // TODO: FunctionNodeType.DESCRIPTION_PATTERN);
   ...
   /**
    * The text field for the function name. Never <code>null</code>.
    */
   private final JTextField _nameField;

   /**
    * The text area for the function description. Never <code>null</code>.
    */
   ...
   private void projectNodeChanged(ProjectNode node) {
      ...
      AppCenter.LOG.debug("FunctionOverviewPanel: projectChanged.");
      ...
      // Otherwise display some details
         ...
         _nameField.setText(function.getName());
         _descrArea.setText(function.getDescription());
         revalidate();
      }
   }
